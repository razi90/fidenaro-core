...
pub struct PublishingConfiguration {
    ...
    pub exchange_information:
        ExchangeIndexedData<Option<ExchangeInformation<PoolHandling>>>,
...
pub struct PublishingReceipt {
    ...
    pub exchange_information:
        ExchangeIndexedData<Option<ExchangeInformation<ComponentAddress>>>,
...
pub struct ExchangeInformation<P> {
