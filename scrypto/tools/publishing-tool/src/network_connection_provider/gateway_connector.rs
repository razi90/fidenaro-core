...
use radix_engine::transaction::VersionedTransactionReceipt;
use radix_transactions::manifest::*;
use scrypto_test::prelude::HasIntentHash;
use scrypto_test::prelude::NotarizedTransactionV1;
use scrypto_test::prelude::PreviewIntentV1;
use scrypto_test::prelude::PublicKey;
use scrypto_test::prelude::TransactionHashBech32EncodeError;
use scrypto_test::prelude::TransactionHashBech32Encoder;
use scrypto_test::prelude::TransactionPayload;
...
impl NetworkConnectionProvider for GatewayNetworkConnector {
    ...
    ) -> Result<crate::network_connection_provider::ExecutionReceipt, Self::Error>
    {
...
pub enum GatewayExecutorError {
    ...
    NotarizedTransactionPrepareError(radix_transactions::prelude::PrepareError),
